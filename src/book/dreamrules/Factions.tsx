      ...
      <Text>
        ...
        <Definitions>
          ...
          <dd>
            ...
            <p>
              On the backside of the token is a "pass"-icon, indicating this faction is no longer able/willing
              take actions this phase.
            </p>
          </dd>
          ...
          <dd>
            <p>Some factions will have unique items, such as a Kwisatz Haderach token for house Atreides.</p>
          </dd>
        </Definitions>
  ...
  return (
    <Spaced>
      ...
      <FactionSynopsis image='/generated/token/faction/emperor.jpg'>
        <h1>Emperor</h1>
        <p>
          his majesty the Padishah Emperor Shaddam IV of house Corrino — keen and efficient, yet easily lulled
          into complacency by his own trappings of power.
        </p>
      </FactionSynopsis>
      ...
      <FactionSynopsis image='/generated/token/faction/fremen.jpg'>
        ...
        <p>
          ...
          life and travel on the planet, and dedicated to preventing any outside control while bringing about
          Dune’s own natural regeneration.
        </p>
      </FactionSynopsis>
    ...
    <Spaced>
      ...
      <FactionSynopsis flip image='/generated/token/faction/bene-tleilaxu.jpg'>
        ...
        <p>
          ...
          deadly Face Dancers. Although loathed by other factions, they are tolerated because of the miracles
