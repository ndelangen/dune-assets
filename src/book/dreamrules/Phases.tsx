    ...
    <Spaced>
      ...
      <Text columns={2}>
        ...
        <ol>
          ...
          <li>
            <p>
              The faction that the Traitor card belongs to, now has a brief time-window to call traitor on the
              Bene Tleilaxu leader placed on top of the Traitor card.
            </p>
          </li>
        </ol>
        <NonBreaking>
          <Text>
            <p>
              If the traitor is called, the Tleilaxu leader dies, and the faction does not become infiltrated.
            </p>
            <h1>Infiltrated</h1>
            <p>
      ...
      <Text columns={2}>
        ...
        <NonBreaking>
          <Text>
            ...
            <ol>
              <li>
                Players that are currently allied can break their alliance by returning the Alliance card they
                received, and taking back their own.
              </li>
              <li>
  ...
  return (
    <Spaced>
      ...
      <Text columns={2}>
        ...
        <ul>
          <li>
            The first player in Storm Order will open bidding on the first card. If that player already has 4
            Treachery Cards the next player who does not have 4 Treachery Cards opens bidding.
          </li>
          <li>
  ...
  return (
    <Spaced>
      <Text columns={2}>
        ...
        <p>
          Bidding for Treachery Cards continues until all cards available for bid have been auctioned off or a
          card is not bid on by anyone.
        </p>
        <p>
        ...
        <Outline variant='normal'>
          ...
          <p>
            ...
            Prescience where they announce to the table that they are about to use them thus giving players a
          ...
          <p>
            ...
            player is asking for subsidy from their ally or the Emperor, we recommend asking for an amount of
            Spice and accepting a yes or no answer to keep the round moving. This will also allow allies to
            share their plans on who should buy what and how much Spice they can share between them. Complex
            deals should be saved for this time period.
          </p>
          <p>
            Once bidding starts on a card, each players bid should take no more than 10 seconds. Simple deals
            can take part in this time however the game should not be paused to allow a complex deal to take
            place.
          </p>
          <p>
            When it is a players turn to bid they should have priority in making simple deals. This means that
            other players should be quiet and interfere minimally when they make deals during their 10
            seconds.
          </p>
          <p>
...
export function Revival() {
  return (
    <Spaced>
      ...
      <Text>
        <p>
          All revivals happen in Storm Order for purposes of the Bene Tleilaxu's Revival Income, and the Bene
          Tleilaxu always revive their Troop tokens and leaders last.
        </p>
        <h1>Force Revival</h1>
  ...
  return (
    <Spaced>
      ...
      <Text>
        <h1>Storm Order</h1>
        <p>
          Shipment and Movement happens in Storm Order by default. Each player's turn consists of one shipment
          and one movement. If the Spacing Guild is in the game, their Ship When You Wish advantage takes
          precedence to Storm Order. After the Spacing Guild has used this advantage, Shipment and Movement
          proceeds in strict Storm Order until all factions have had a chance to Ship and Move.
        </p>
        <h1>Shipment</h1>
        <p>
          A player may make one shipment of any number of tokens from their reserves to any one territory on
          the map. A player must pay spice to the spice bank for their shipment or to the Guild if they are in
          the game. The cost of shipping off-planet reserves is one spice per token shipped into any
          stronghold or city, and two spice per token shipped to any other territory. The Fremen player does
          not have to pay as their reserves are on the far side of Dune, see their faction sheet for details.
        </p>
      </Text>
    </Spaced>
  );
  ...
  return (
    <Spaced>
      ...
      <Text columns={2}>
        ...
        <p>
          The Stronghold Shield Wall counts as a Rock Territory in terms of Shipment, Movement and occupation
          limits.
        </p>

        <p>
          Each player may move, as a stack, any number of their Troop tokens from one territory into one other
          territory. The default move limit is one Territory.
        </p>
        ...
        <NonBreaking>
          <Text>
            ...
            <p>
              ...
              If a factions forces are split into 2 or more sectors of the same territory, they may all leave
              the territory with one movement action as a stack. To recombine these forces into one stack
              while remaining in that territory requires one movement action.
            </p>
            <p>
              ...
              covered by the storm. When ending a move in a territory lying in several sectors, a player must
              make clear in which sector of the territory they choose to leave their tokens. The polar sink is
              never in storm. Tokens do not block movement with one exception: Like shipment, tokens cannot be
              moved into or through a stronghold if tokens of two other players are already there. Otherwise,
              tokens are free to move into, out of, or through any territory occupied by any number of tokens.
            </p>
          </Text>
        </NonBreaking>
      </Text>
      ...
      <Text columns={2}>
        ...
        <NonBreaking>
          <Text>
            ...
            <p>
              The winning player loses the Troop tokens they dialed in battle, as well as the Spice they used.
            </p>
        ...
        <NonBreaking>
          <Text>
            ...
            <Outline variant='normal'>
              Note that the loser does not lose their leader as a result of battle. Leaders are killed only by
              weapon Treachery Cards.
            </Outline>
          </Text>
        </NonBreaking>
      </Text>
      ...
      <Text columns={2}>
        ...
        <NonBreaking>
          <Text>
            <h1>Battle wheel</h1>
            <p>
              Each player picks up a Battle Wheel and secretly dials a number from zero to the number of Troop
              tokens they have in the disputed territory. Both players will lose the number of Troop tokens
              dialed on the Battle Wheel.
            </p>
            <p>The maximum dial is 20, even if you have more Troop tokens or if Troops add more strength.</p>
          </Text>
        </NonBreaking>
        <NonBreaking>
          <Text>
...
export function Mentat() {
  return (
    <Spaced>
      ...
      <Text>
        <p>
          During this phase players check if any of the players meet the following conditions for winning the
          game:
        </p>
        <Definitions>
          <dt>
      ...
      <Text columns={2}>
        <NonBreaking>
          <Text>
            ...
            <p>Players that do not have an ally, will win the game if they have at least 3 Victory Points.</p>
      ...
      <Text columns={2}>
        ...
        <p>
          Players are allowed to bribe each other during the Collection phase, to be able to use the charity.
        </p>
        <p>
...
export function Storm() {
  return (
    <Spaced>
      ...
      <Text columns={2}>
        <p>
          The Storm Marker is moved around the map. The faction whose Player Marker the storm next approaches
          will be the First Player for this turn.
        </p>
        ...
        <p>
          ...
          advance the Storm Marker from its current position counterclockwise around the map for the sum total
          of sectors.
        </p>
        ...
        <NonBreaking>
          ...
          <p>
            ...
            sand territory are protected from the storm. In addition any Spice in a sector over which a storm
            passes or stops is removed to the Spice Bank.
          </p>
        </NonBreaking>
        <NonBreaking>
          <h1>Obstruction</h1>
