    ...
    <Spaced>
      ...
      <Text columns={3} size={1.8}>
        <div style={{ padding: '1vw 4vw' }}>
          ...
          >
            <img width={cardSize.width} src='/generated/card/treachery/worthless/baliset.jpg' alt='baliset' />
            <img width={cardSize.width} src='/generated/card/treachery/worthless/baliset.jpg' alt='baliset' />
            <img width={cardSize.width} src='/generated/card/treachery/worthless/baliset.jpg' alt='baliset' />
          </Fan>
        </div>
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          <h1>Chemistry</h1>
          <p>
            Playing this card in your battle plan with a second defense will kill the opponent's leader unless
            they have a poison defense in their battle plan.
          </p>
          <p>
            Playing this card in your battle plan without a second defense protects your leader from a poison
            weapon.
          </p>
          <p>
      ...
      <SideBySide>
        <div style={{ padding: '2vw 6vw', width: '20vw', flex: 'none' }}>
          <Fan
            ...
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
          >
            <img width={cardSize.width} src='/generated/card/treachery/defense/shield.jpg' alt='shield' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/shield.jpg' alt='shield' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/shield.jpg' alt='shield' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/shield.jpg' alt='shield' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/shield.jpg' alt='shield' />
      ...
      <SideBySide>
        <div style={{ padding: '2vw 6vw', width: '20vw', flex: 'none' }}>
          <Fan
            ...
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
          >
            <img width={cardSize.width} src='/generated/card/treachery/defense/snooper.jpg' alt='snooper' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/snooper.jpg' alt='snooper' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/snooper.jpg' alt='snooper' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/snooper.jpg' alt='snooper' />
            <img width={cardSize.width} src='/generated/card/treachery/defense/snooper.jpg' alt='snooper' />
  ...
  return (
    <Spaced>
      ...
      <SideBySide>
        <div style={{ padding: '2vw 6vw', width: '24vw', flex: 'none' }}>
          <Fan
            ...
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
          >
            <img width={cardSize.width} src='/generated/card/treachery/unique/karama.jpg' alt='karama' />
            <img width={cardSize.width} src='/generated/card/treachery/unique/karama.jpg' alt='karama' />
          </Fan>
        </div>
        <Text style={{ flex: 1 }} size={1.7}>
          ...
          <Outline variant='normal'>
            ...
            <ol>
              ...
              <li>
                During <strong>your</strong> shipment and movement turn, your shipment cost is reduced to half
                of normal. Your payment for this shipment goes to the Spice Bank.
              </li>
            </ol>
          </Outline>
        </Text>
      ...
      <Text columns={2}>
        <Outline variant='example'>
          <p>
            When playing a karama to stop the Spacing Guild from using their storm order advantage during ship
            and move, you must do so before the Spacing Guild was supposed to take their turn.
          </p>
        </Outline>
        <Outline variant='example'>
          <p>
            When playing a karama to stop the Bene Gesserit from using their voice advantage against you, you
            can listen to what their voice is, but must play the karama before proceeding with further
            actions/revealing.
          </p>
        </Outline>
      </Text>
    ...
    <Spaced>
      ...
      <Text columns={2} size={1.7}>
        ...
        <p>
          ...
          <br />
          You must commit to an answer and then you are not allowed to make game actions that would make your
          answer not true.
        </p>
        ...
        <p>
          ...
          deliberately unclear questions, or questions that are effectively a card-blanc "you must do exactly
          the thing i decide you must do".
        </p>
        <ul>
      ...
      <Text columns={2} size={1.7}>
        <NonBreaking>
          <Text>
            ...
            <Outline variant='example'>
              Will you have more than 4 Troop tokens in Arrakeen by the end of your shipment & movement turn?
            </Outline>
          </Text>
        </NonBreaking>
        <NonBreaking>
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          <h1>Cheap hero</h1>
          <p>
            There are 3 Cheap Hero cards in the Treachery deck, 2 are called "Cheap Hero", 1 is called "Cheap
            Heroine".
            <br />
          ...
          <p>
            A Cheap Hero card is always discarded after use. Unless you won with Traitor, in that case you can
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            You can only play this card if you have at least 1 Troop token in an territory adjacent or on the
            Shieldwall territory.
            <br />
    ...
    <Spaced>
      ...
      <SideBySide>
        ...
        <Text style={{ flex: 1 }}>
          ...
          <p>
            When asked for dial as Atreides battle prescience, you must answer the number of your Battlewheel
            and must also disclose if you are playing Mercenaries.
          </p>
      ...
      <SideBySide>
        <div style={{ padding: '2vw 2vw', width: '24vw', flex: 'none' }}>
          <Fan
            ...
            style={{ boxShadow: '0.5vw 0.5vw 0.5vw rgba(0, 0, 0, 0.5)', borderRadius: '1vw' }}
          >
            <img width={cardSize.width} src='/generated/card/treachery/unique/supplies.jpg' alt='supplies' />
          </Fan>
          <div
            style={{
              padding: '0 6vw',
          ...
          >
            ...
            >
              ...
              <img
                ...
                alt='phrine-pen'
              />
              <img width={cardSize.width} src='/generated/card/treachery/supplies/shield.jpg' alt='shield' />
            </Fan>
          </div>
        </div>
        <Text style={{ flex: 1 }}>
          ...
          <p>
            ...
            <br />
            Effectively this means you are allowed to play it at start of battle, before any battle advantages
            are used.
          </p>
          <p>
            When you play the Supplies! card, you discard it and take the 4 Supplies! Treachery cards from the
            supply, into your hand.
            <br />
